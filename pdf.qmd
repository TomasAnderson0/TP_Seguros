...
```{r, echo=FALSE, warning=FALSE, fig.cap= "Función de densidad Weibull estimada vs Función de densidad observada", message=FALSE}
...
ggplot(resultado) +
  ...
  annotate("text",x = quantile(resultado$s, probs = .99) + 65, y = 1250, label = "Percentil 99%") +
    annotate("text",x = quantile(resultado$s, probs = .5) + 65, y = 1250, label = "Percentil 50%") +
...
ggplot(resultado) +
  ...
  annotate("text",x = quantile(resultado$c, probs = .99) + 35, y = 1150, label = "Percentil 99%") +
    annotate("text",x = quantile(resultado$c, probs = .5) + 35, y = 1150, label = "Percentil 50%") +
  labs(x = "Millones de pesos (a precios de 2024)", y = "Frecuencia absoluta") +
...
ggplot(resultado_sampling) +
  ...
  geom_vline(aes(xintercept  = quantile(c, probs = .99)), linewidth = .75, color = "darkgreen")  +
  geom_vline(aes(xintercept  = quantile(c, probs = .5)), linewidth = .75, color = "darkgreen")  +
  annotate("text",x = quantile(resultado_sampling$c, probs = .99) + 38, y = 1100, label = "Percentil 99%") +
    annotate("text",x = quantile(resultado_sampling$c, probs = .5) + 35, y = 1100, label = "Percentil 50%") +
  labs(x = "Millones de pesos (a precios de 2024)", y = "Frecuencia absoluta") +
  scale_x_continuous(breaks = seq(1500, 2300, 50)) +
  scale_y_continuous(limits = c(0, 1200))
```
